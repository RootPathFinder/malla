...
@pytest.mark.unit
def test_schema_includes_dwell_burst_fields():
...
@pytest.mark.unit
def test_apply_and_read_dwell_burst_unknown_fields():
    ...
    assert parsed["detection_trigger_type"] == 3
...
@pytest.mark.unit
def test_detection_sensor_to_dict_defaults_custom_fields_zero():
